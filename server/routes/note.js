...
router.get('/', middleware,async (req,res) => {
    try {
        ...
        return res.status(500).json({success:false, message: "connect retrive notes"})
    }
})
...
router.put('/:id', async (req,res) => {
    try {
        ...
        return res.status(500).json({success:false, message: "connect update notes"})
...
router.delete('/:id', async (req,res) => {
    try {
        ...
        return res.status(500).json({success:false, message: "connect Delete notes"})
